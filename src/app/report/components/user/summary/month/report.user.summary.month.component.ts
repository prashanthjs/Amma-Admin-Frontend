...
import {
  CHART_BAR_NORMAL_OPTIONS, CHART_LINE_COLORS
...
@Component({
  selector: 'app-report-user-summary-monthly',
  templateUrl: './report.user.summary.month.template.html'
})
export class ReportUserSummaryMonthComponent implements OnInit, OnDestroy {
