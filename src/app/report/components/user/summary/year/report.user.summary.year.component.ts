...
@Component({
  selector: 'app-report-user-summary-year',
  templateUrl: './report.user.summary.year.template.html'
})
export class ReportUserSummaryYearComponent implements OnInit, OnDestroy {
